...
const PILARES = [
  ...
  },
  {
    ...
    texto:
      'As palavras que você ouviu viram o SEU baralho: revisão espaçada e minijogos com o seu próprio conteúdo, não listas prontas.',
  },
  {
    icone: <ShieldCheck className="w-5 h-5" />,
    titulo: 'Privado por padrão',
    texto:
      'No plano grátis, transcrição e tradução rodam no seu computador: sem conta, sem envio de áudio, sem rastreio. Quem escolhe a qualidade de nuvem sabe o que está mandando, e por quê. É verificável: o código é aberto.',
  },
];
...
export default function Sobre({ onVerPlanos }: { onVerPlanos?: (view: string) => void } = {}) {
  ...
  const copiarPix = async () => {
    try {
      ...
      /* clipboard bloqueado: o texto está visível para copiar à mão */
    }
  };
    ...
    <div className="flex-1 h-full min-h-0 overflow-y-auto custom-scrollbar" aria-label="Sobre">
      <div className="relative max-w-5xl mx-auto px-4 sm:px-8 py-10 space-y-16 animate-in fade-in duration-300">
        ...
        <section className="relative overflow-hidden rounded-3xl border border-border-subtle bg-surface px-6 py-10 sm:px-10 sm:py-12">
          {/* `sobre-decor` recorta o miolo desta camada (ver `index.css`): decoração não fica atrás de
            texto nem de controle, e o brilho continua nas bordas. Decisão do dono, D-011. */}
          <div aria-hidden className="sobre-decor pointer-events-none absolute inset-0">
          ...
          <div className="relative grid md:grid-cols-[auto_1fr] gap-8 md:gap-12 items-center">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[15px] text-ink-muted leading-relaxed mt-4 max-w-2xl">
                Porque acredito numa ideia simples:{' '}
                <b className="text-ink">a melhor aula de idioma é o conteúdo que você já ama assistir</b>. Esta página
                conta como isso virou um app, e como você pode fazer parte.
              </p>
              <div className="flex flex-wrap items-center gap-2 mt-6">
                <LinkDoCriador
                  href={CRIADOR.portfolio}
                  icone={<Globe className="w-4 h-4" />}
                  rotulo="Meu portfólio"
                  destaque
                />
        ...
        <section className="grid lg:grid-cols-[1fr_260px] gap-10">
          <div className="min-w-0">
            ...
            <div className="space-y-4 text-[15px] text-ink-muted leading-relaxed">
              ...
              <p>
                Tudo começou com uma frustração minha: eu passava horas assistindo a vídeos, lives e jogando com gente
                do mundo inteiro, e <b className="text-ink">entendia metade</b>. As ferramentas que existiam cobravam
                antes de eu saber se serviam, exigiam conta para qualquer coisa, ou simplesmente não funcionavam com o
                que EU queria assistir.
              </p>
              <p>
                Então resolvi construir a ferramenta que eu queria usar: aperta o play em qualquer coisa, e o Babel Play
                escuta junto com você. A fala vira legenda na hora, a tradução aparece do lado, e cada palavra nova que
                passa pela sua tela pode virar
                <b className="text-ink"> material de estudo seu</b>, para revisar e jogar depois.
              </p>
              <p>
                E uma decisão que eu não abro mão: <b className="text-ink">aprender aqui é grátis, e vai continuar</b>.
                Gravar, traduzir, jogar e revisar funcionam sem conta e sem pagar nada — os modelos são baixados uma vez
                e trabalham no seu computador, então o seu áudio não sai da sua máquina. Não é promessa de marketing: o
                código é aberto e qualquer pessoa pode conferir.
              </p>
              <p>
                O que custa dinheiro é o que custa dinheiro para mim. Se você quiser a{' '}
                <b className="text-ink">tradução da nuvem</b>, que é bem melhor que a local, ela roda num servidor que
                eu pago — e aí sim o que você manda para lá sai do seu computador, com a sua permissão e sabendo o
                motivo. E tem o <b className="text-ink">enfeite</b>: temas, efeitos, o Passe de Temporada. Nada disso
                ensina nada. É só bonito, e é o que ajuda a manter o resto de pé.
              </p>
        ...
        <section>
          <div className="grid sm:grid-cols-3 gap-4">
            {PILARES.map((p) => (
              ...
              >
                <span className="w-11 h-11 rounded-2xl bg-accent-soft text-accent-ink flex items-center justify-center">
                  {p.icone}
                </span>
        ...
        <section className="grid md:grid-cols-[1fr_300px] gap-10 items-start">
          <div className="min-w-0">
            ...
            <div className="space-y-4 text-[15px] text-ink-muted leading-relaxed">
              <p>
                Sou o {CRIADOR.nome}, desenvolvedor brasileiro, apaixonado por inteligência artificial e por transformar
                tecnologia difícil em coisa que qualquer pessoa consegue usar. O Babel Play é o meu projeto mais
                pessoal: pesquisa, código, design, testes e até esta página, tudo feito por uma pessoa só, aprendendo em
                público e publicando cada passo no GitHub.
              </p>
              <p>
                Se você quiser ver o que mais eu construo, ou trocar uma ideia sobre tecnologia, idiomas ou projetos
                independentes, as portas estão logo ali ao lado. Eu respondo.
              </p>
            </div>
          </div>
          ...
          <div className="relative grid lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="space-y-4 text-[15px] text-ink-muted leading-relaxed mt-4">
                <p>
                  O Babel Play não tem empresa, investidor nem publicidade de terceiros. O que ele tem é uma pessoa
                  pagando domínio e servidor do próprio bolso e investindo as horas livres para cada versão ficar melhor
                  que a anterior — e, agora, uns planos e enfeites à venda para essa conta fechar.
                </p>
                <p>
                  Se ele te ajudou a entender um vídeo, a ganhar uma partida, ou a aprender uma palavra nova,{' '}
                  <b className="text-ink">qualquer gesto mantém o projeto vivo</b>: um Pix do tamanho de um café, uma
                  estrela no GitHub, um comentário contando como você usa, ou simplesmente mostrar o app para alguém.
                </p>
              </div>
            </div>
            <div className="space-y-3">
              {preenchido(CRIADOR.pix) && (
                <div className="flex items-center gap-2">
                  <code className="flex-1 min-w-0 truncate px-4 py-3 rounded-xl bg-canvas border border-border-subtle text-[13px] text-ink">
                    {CRIADOR.pix}
                  </code>
                  <button
                    onClick={copiarPix}
              ...
              <div className="grid sm:grid-cols-1 gap-2">
                <LinkDoCriador
                  ...
                  rotulo="Deixar um comentário"
                />
                <LinkDoCriador
                  href={CRIADOR.issues}
                  icone={<Github className="w-4 h-4" />}
                  rotulo="Reportar um problema"
                />
                <LinkDoCriador
                  href={CRIADOR.github + '/babel-play'}
                  icone={<Star className="w-4 h-4" />}
                  rotulo="Dar uma estrela no GitHub"
                />
              </div>
            </div>
          </div>
        ...
        <p className="flex items-center justify-center gap-3 text-[12px] text-ink-faint pb-6">
          <a href="/privacidade.html" className="underline hover:text-ink">
            Política de privacidade
          </a>
          <span aria-hidden>·</span>
          <a href="/termos.html" className="underline hover:text-ink">
            Termos de uso
          </a>
        </p>
      </div>
