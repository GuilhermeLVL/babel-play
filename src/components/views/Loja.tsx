...
import { CATALOGO_DA_LOJA, COR_DA_RARIDADE, estadoDoItem, type ItemDaLoja, marcarPosse } from '../../lib/loja';
        ...
        <PainelDeAba id="loja" ativo={aba}>
          ...
          embora, com um atalho para onde ela é desenhada. */}
             ...
             o que uma vitrine tem de ser. */}
              ...
              {/* ── FILTROS — pílula ativa em ink (D-012), como as categorias de Jogar ── */}
              <div className="flex flex-wrap gap-1.5">
                {FILTROS.map((f) => (
                  <button
                    ...
                    className={`kpi-pill ${filtro === f.id ? 'active' : ''}`}
                  >
                    {f.nome}
                  </button>
                ))}
